...
void ::SuperpoweredPlayer::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::SuperpoweredPlayer::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SuperpoweredPlayer::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
